      ...
      <div className="container">
        <div className="lg:grid lg:grid-cols-2">
          <div className="">
            ...
            <p className='mb-5 text-zinc-400 lg:max-w-[35ch]'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque voluptate, quisquam provident ratione corrupti sed veniam voluptatem. Perferendis recusandae laborum, et fugit consequuntur voluptatum quod incidunt sit. Nisi, laboriosam earum.
            </p>
            <div className="flex gap-5 mb-5">
              <a href="https://t.me/odilbekdev" target='_blank'><FaTelegram size={25} /></a>
              <a href="https://www.instagram.com/" target='_blank'><FaSquareInstagram size={25} /></a>
              <a href="https://www.facebook.com/profile.php?id=100094416551089" target='_blank'> <FaFacebook size={25} /></a>
          ...
          <form onSubmit={handleSubmit} className="">
            ...
            <button type='submit' className='btn btn-primary md:block md:w-full sm:h-auto p-3'>Submit</button>
          </form>
        </div>
      </div>
    </section>
